...
> Scoop 與 winget 已可用。Chocolatey 的套件仍在社群審核中，通過後即可安裝。
...
> Scoop and winget are available now. The Chocolatey package is pending community moderation and will install once approved.
